...
#else
    module = Py_InitModule3("iterize._iterize", module_functions, NULL);
#endif
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC init_iterize(void) {
    moduleinit();
}
#else
PyMODINIT_FUNC PyInit__iterize(void) {
    return moduleinit();
}
#endif
